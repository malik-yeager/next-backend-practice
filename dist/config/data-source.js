...
exports.AppDataSource = new typeorm_1.DataSource({
    ...
    synchronize: true,
    logging: true,
    entities: [User_1.User, Account_1.Account, Session_1.Session, Verification_1.VerificationToken, Role_1.Role, RolePermission_1.RolePermission, ModulePermission_1.ModulePermission, Category_1.Category, Tag_1.Tag, Post_1.Post, AuditLog_1.AuditLog, Draft_1.Draft],
